  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "Nafissatou Ndiaye",
          from_email: form.email,
          to_email: "nafissatou.ndiaye.epro@gmail.com",
      ...
      .then(
        () => {
          setLoading(false);
          alert("Merci. Je vous répondrai aussi tôt que possible.");
        ...
        (error) => {
          ...
          alert("Ahh, une erreur s'est produite. Veuillez réessayer.");
        }
      );
  };
        ...
        >
          ...
          <label className="flex flex-col">
            ...
            <textarea
              ...
              value={form.message}
              onChange={handleChange}
              placeholder="Que voulez-vous m'addresser ?"
              className="bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outline-none border-none font-medium"
            />
          </label>
